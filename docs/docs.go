    ...
    "paths": {
        "/analytics": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/model.AnalyticsEvent"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Analytics Event Info",
                        "name": "event",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.LogEventRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request body or event type",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponse"
                        }
                    },
        ...
        "/projects/{id}/assets": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid project ID or file error",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponse"
                        }
                    },
        ...
        "/projects/{projectId}/render/{assetId}": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid project or asset ID",
                        "schema": {
                            "$ref": "#/definitions/utils.ErrorResponse"
                        }
                    },
    ...
    "definitions": {
        "handler.CreateProjectRequest": {
            ...
            "properties": {
                "description": {
                    "type": "string",
                    "example": "A cool playable ad project."
                },
                "title": {
                    "type": "string",
                    "example": "My First Ad"
